...
@section('content')
    <div class="mb-6 flex items-center gap-3">
        ...
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Editar Rango de Arbitrio</h1>
        </div>
    </div>

    <div class="card max-w-3xl">
        <div class="card-body">
            <form action="{{ route('admin.tabla-arbitrios.update', $arbitrio) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                    <div class="form-group mb-0 md:col-span-2">
                        ...
                        <input type="text" name="descripcion" id="descripcion" class="form-input" value="{{ old('descripcion', $arbitrio->descripcion) }}" placeholder="Ej. Ingresos de Q3,000.01 a Q5,000.00">
                    ...
                    <div class="form-group mb-0">
                        ...
                        <input type="number" step="0.01" min="0" name="rango_inicio" id="rango_inicio" class="form-input font-mono" value="{{ old('rango_inicio', $arbitrio->rango_inicio) }}" required>
                    ...
                    <div class="form-group mb-0">
                        ...
                        <input type="number" step="0.01" min="0" name="rango_fin" id="rango_fin" class="form-input font-mono" value="{{ old('rango_fin', $arbitrio->rango_fin) }}" required>
                    ...
                    <div class="form-group mb-0 md:col-span-2">
                        ...
                        <input type="number" step="0.01" min="0" name="monto" id="monto" class="form-input text-xl font-bold text-primary-700 py-3" value="{{ old('monto', $arbitrio->monto) }}" required>
                ...
                <div class="form-group flex items-center mt-6">
                    ...
                    <input type="checkbox" name="activo" id="activo" value="1" class="w-5 h-5 text-primary-600 rounded border-gray-300 focus:ring-primary-500" {{ old('activo', $arbitrio->activo) ? 'checked' : '' }}>
